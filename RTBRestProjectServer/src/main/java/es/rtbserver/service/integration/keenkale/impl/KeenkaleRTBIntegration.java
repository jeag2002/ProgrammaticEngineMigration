package es.rtbserver.service.integration.keenkale.impl;
...
import es.rtbserver.controller.RTBMVCController;
import es.rtbserver.service.integration.RTBIntegration;
import es.rtbserver.service.integration.keenkale.bean.ResponseBean;
...
public class KeenkaleRTBIntegration extends RTBIntegration {
	...
	private ResponseBean processBean() {
		...
		es.rtbserver.service.integration.keenkale.bean.Imp imp = new es.rtbserver.service.integration.keenkale.bean.Imp();
		...
		es.rtbserver.service.integration.keenkale.bean.Banner banner = new es.rtbserver.service.integration.keenkale.bean.Banner();  
		...
		es.rtbserver.service.integration.keenkale.bean.Device device = new es.rtbserver.service.integration.keenkale.bean.Device();
		...
		es.rtbserver.service.integration.keenkale.bean.Geo geo = new es.rtbserver.service.integration.keenkale.bean.Geo();
		//geo.setCountry("ESP");
		...
		es.rtbserver.service.integration.keenkale.bean.App app = new es.rtbserver.service.integration.keenkale.bean.App();
		...
		es.rtbserver.service.integration.keenkale.bean.Publisher pub = new es.rtbserver.service.integration.keenkale.bean.Publisher();
		pub.setId("67fbd985230c665850075df702d12c5e");
		pub.setName("tappx");
		pub.setDomain("tappx.com");
		app.setPublisher(pub);
		
		es.rtbserver.service.integration.keenkale.bean.User user = new es.rtbserver.service.integration.keenkale.bean.User();
		
		es.rtbserver.service.integration.keenkale.bean.Geo_ geo_1 = new es.rtbserver.service.integration.keenkale.bean.Geo_();
		...
		List<es.rtbserver.service.integration.keenkale.bean.Imp> impLst = new ArrayList<es.rtbserver.service.integration.keenkale.bean.Imp>();
		impLst.add(imp);
		rBean.setImp(impLst);
